...
// 异步读取
fs.readFile(__dirname+'/fs_text.txt', function (err, data) {
    console.log("------------------------------------------------------------异步读取 分割线---");
    if (err) {
...
// 同步读取
console.log("-------------------------------------------------同步读取 分割线");
var data = fs.readFileSync(__dirname+'/fs_text.txt');
